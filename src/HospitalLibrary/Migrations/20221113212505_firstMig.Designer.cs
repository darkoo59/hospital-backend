...
namespace HospitalLibrary.Migrations
{
    ...
    [Migration("20221113212505_firstMig")]
            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DoctorId = 1,
                            PatientId = 1,
                            Start = new DateTime(2022, 11, 13, 22, 25, 4, 597, DateTimeKind.Local).AddTicks(3963)
                        });
                });
            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.VacationRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VacationRequestId = 1,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 11, 28, 22, 25, 4, 600, DateTimeKind.Local).AddTicks(6305),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 11, 23, 22, 25, 4, 600, DateTimeKind.Local).AddTicks(5972),
                            Status = 1,
                            Urgency = "NoUrgent"
                        },
                        new
                        {
                            VacationRequestId = 2,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 3, 22, 25, 4, 600, DateTimeKind.Local).AddTicks(7520),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 11, 28, 22, 25, 4, 600, DateTimeKind.Local).AddTicks(7509),
                            Status = 2,
                            Urgency = "Urgent"
                        },
                        new
                        {
                            VacationRequestId = 3,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 8, 22, 25, 4, 600, DateTimeKind.Local).AddTicks(7526),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 3, 22, 25, 4, 600, DateTimeKind.Local).AddTicks(7523),
                            Status = 0,
                            Urgency = "NoUrgent"
                        });
                });
