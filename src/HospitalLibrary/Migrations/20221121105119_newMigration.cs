    ...
    public partial class newMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 4, new DateTime(2022, 12, 11, 11, 51, 18, 819, DateTimeKind.Local).AddTicks(7111), "Tired", new DateTime(2022, 12, 6, 11, 51, 18, 819, DateTimeKind.Local).AddTicks(7099), 2, "Urgent" },
                    { 1, 4, new DateTime(2022, 12, 6, 11, 51, 18, 819, DateTimeKind.Local).AddTicks(5962), "Tired", new DateTime(2022, 12, 1, 11, 51, 18, 819, DateTimeKind.Local).AddTicks(5623), 1, "NoUrgent" },
                    { 3, 4, new DateTime(2022, 12, 16, 11, 51, 18, 819, DateTimeKind.Local).AddTicks(7119), "Tired", new DateTime(2022, 12, 11, 11, 51, 18, 819, DateTimeKind.Local).AddTicks(7117), 0, "NoUrgent" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, new DateTime(2022, 11, 21, 11, 51, 18, 816, DateTimeKind.Local).AddTicks(68) });
