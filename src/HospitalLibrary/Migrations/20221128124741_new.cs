    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 4, new DateTime(2022, 12, 18, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(541), "Tired", new DateTime(2022, 12, 13, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(522), 2, "Urgent" },
                    { 3, 4, new DateTime(2022, 12, 23, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(550), "Tired", new DateTime(2022, 12, 18, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(547), 0, "NoUrgent" },
                    { 1, 4, new DateTime(2022, 12, 13, 13, 47, 40, 839, DateTimeKind.Local).AddTicks(8405), "Tired", new DateTime(2022, 12, 8, 13, 47, 40, 839, DateTimeKind.Local).AddTicks(7870), 1, "NoUrgent" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, new DateTime(2022, 11, 28, 13, 47, 40, 833, DateTimeKind.Local).AddTicks(9056) });
