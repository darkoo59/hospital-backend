...
namespace HospitalLibrary.Migrations
{
    ...
    [Migration("20221205172657_AddExaminationReportTable")]
    partial class AddExaminationReportTable
    {
            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.VacationRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VacationRequestId = 1,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 20, 18, 26, 54, 793, DateTimeKind.Local).AddTicks(9625),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 15, 18, 26, 54, 786, DateTimeKind.Local).AddTicks(87),
                            Status = 1,
                            Urgency = "NoUrgent"
                        },
                        new
                        {
                            VacationRequestId = 2,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 25, 18, 26, 54, 794, DateTimeKind.Local).AddTicks(5060),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 20, 18, 26, 54, 794, DateTimeKind.Local).AddTicks(5031),
                            Status = 2,
                            Urgency = "Urgent"
                        },
                        new
                        {
                            VacationRequestId = 3,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 30, 18, 26, 54, 794, DateTimeKind.Local).AddTicks(5074),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 25, 18, 26, 54, 794, DateTimeKind.Local).AddTicks(5068),
                            Status = 0,
                            Urgency = "NoUrgent"
                        });
                });
