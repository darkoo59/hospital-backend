            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DoctorId = 1,
                            PatientId = 1,
                            Start = new DateTime(2022, 11, 26, 20, 43, 47, 304, DateTimeKind.Local).AddTicks(2523)
                        });
                });
            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.VacationRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VacationRequestId = 1,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 11, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(6837),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 6, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(6478),
                            Status = 1,
                            Urgency = "NoUrgent"
                        },
                        new
                        {
                            VacationRequestId = 2,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 16, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7929),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 11, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7918),
                            Status = 2,
                            Urgency = "Urgent"
                        },
                        new
                        {
                            VacationRequestId = 3,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 21, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7935),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 16, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7932),
                            Status = 0,
                            Urgency = "NoUrgent"
                        });
                });
