    ...
    public partial class mig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 4, new DateTime(2022, 12, 16, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7929), "Tired", new DateTime(2022, 12, 11, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7918), 2, "Urgent" },
                    { 3, 4, new DateTime(2022, 12, 21, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7935), "Tired", new DateTime(2022, 12, 16, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(7932), 0, "NoUrgent" },
                    { 1, 4, new DateTime(2022, 12, 11, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(6837), "Tired", new DateTime(2022, 12, 6, 20, 43, 47, 309, DateTimeKind.Local).AddTicks(6478), 1, "NoUrgent" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, new DateTime(2022, 11, 26, 20, 43, 47, 304, DateTimeKind.Local).AddTicks(2523) });
