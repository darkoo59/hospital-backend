            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DoctorId = 1,
                            PatientId = 1,
                            Start = new DateTime(2022, 11, 28, 13, 47, 40, 833, DateTimeKind.Local).AddTicks(9056)
                        });
                });
            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.VacationRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VacationRequestId = 1,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 13, 13, 47, 40, 839, DateTimeKind.Local).AddTicks(8405),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 8, 13, 47, 40, 839, DateTimeKind.Local).AddTicks(7870),
                            Status = 1,
                            Urgency = "NoUrgent"
                        },
                        new
                        {
                            VacationRequestId = 2,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 18, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(541),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 13, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(522),
                            Status = 2,
                            Urgency = "Urgent"
                        },
                        new
                        {
                            VacationRequestId = 3,
                            DoctorId = 4,
                            EndDate = new DateTime(2022, 12, 23, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(550),
                            Reason = "Tired",
                            StartDate = new DateTime(2022, 12, 18, 13, 47, 40, 840, DateTimeKind.Local).AddTicks(547),
                            Status = 0,
                            Urgency = "NoUrgent"
                        });
                });
