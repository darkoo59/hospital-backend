...
namespace HospitalAPI.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        public AppointmentsController(IGenericMapper<Appointment, AppointmentDTO> appointmentMapper, INotificationService notificationService, IPhysicianScheduleService physicianScheduleService)
        {
